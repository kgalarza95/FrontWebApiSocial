...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="cargartxt.jsp">Cargar TXT</a>
                            <a class="collapse-item" href="cargarhtml.jsp">Cargar HTML</a>
                            <a class="collapse-item" href="cargarxml.jsp">Cargar XML</a>
                            <a class="collapse-item" href="#">Cargar FORM</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../reportes/infocargada.jsp">Informacion Cargada</a>
                            <a class="collapse-item" href="../reportes/datosfb.jsp">Datos Facebook</a>
                            <a class="collapse-item" href="../reportes/datosinstagram.jsp">Datos Instagram</a>
                            <a class="collapse-item" href="../reportes/datostw.jsp">Datos Twitter</a>
                        </div>
                    </div>
                </li>
        ...
        <script src="../../js/eventos/cargardatos/cargarform.js?v=1" type="text/javascript"></script>
