...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="datosfb.jsp">Datos Facebook</a>
                            <a class="collapse-item" href="#">Datos Instagram</a>
        ...
        <script src="../../js/eventos/reportes/datosinstagram.js?v=1" type="text/javascript"></script>
